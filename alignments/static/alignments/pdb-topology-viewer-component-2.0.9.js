 ...
 PdbTopologyViewerPlugin = function() {
  function t() {
   this.defaultColours = {
    ...
    if (this.domainTypes = [{
     ...
     t.innerHTML = i, t.addEventListener("change", this.displayDomain.bind(this)), this.targetEle.querySelector(".resetIcon").addEventListener("click", this.resetDisplay.bind(this))
  ...
  return t.prototype.render = function(t, e) {
       ...
       t.residues.forEach(function(t) {
        ...
        if (1 !== t.outlier_types.length || "RSRZ" !== t.outlier_types[0]) {
         ...
         if (42 ===t.residue_number){
          ...
          viewerInstance2.visual.select({ data: selectSections, nonSelectedColor: {r:0,g:0,b:0}});
   ...
   if (void 0 !== t.eventData && 0 < Object.keys(t.eventData).length) {
    var i = "residueSelection";
	console.log(t.eventData.entity_id, t.eventData.seq_id, this.entityId);
