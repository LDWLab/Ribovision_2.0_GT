...
urlpatterns = [
    ...
    path('extapi/pdbe/summary/<str:pdb>', extapi.pdbe_summary, name='extapi_pdbe_summary'),
    path('extapi/pdbe/emdb-map/<str:pdb>', extapi.pdbe_emdb_map, name='extapi_pdbe_emdb_map'),
    path('extapi/emdb/map/<str:emdb>', extapi.emdb_map, name='extapi_emdb_map'),
    path('extapi/alphafold/prediction/<str:acc>', extapi.alphafold_prediction, name='extapi_alphafold_prediction'),
    path('extapi/pdbe/mappings/<str:pdb>', extapi.pdbe_mappings, name='extapi_pdbe_mappings'),
    path('extapi/pdbe/validation/<str:pdb>', extapi.pdbe_validation, name='extapi_pdbe_validation'),
    ...
    path('extapi/ribosome/polynucleotide', extapi.ribosome_polynucleotide, name='extapi_ribosome_polynucleotide'),
    path('extapi/litemol/chains/<str:pdb>', extapi.litemol_chains, name='extapi_litemol_chains'),
    path('extapi/litemol/residue-range/<str:pdb>', extapi.litemol_residue_range, name='extapi_litemol_residue_range'),
    ...
    path('custom-modified-residues/<str:entity_id>/<path:cif_file_path>', views.custom_modified_residues, name = 'custom_modified_residues'),
