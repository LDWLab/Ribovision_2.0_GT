...
urlpatterns = [
    ...
    path('getPolymerInformationFilterByStrainIDAndGI/<int:strain_id>/<str:gi>', views.getPolymerInformationFilterByStrainIDAndGIDirect, name = "getPolymerInformationFilterByStrainIDAndGI"),
    path('showPolymerInformation/<int:strain_id>/<str:gi>', views.showPolymerInformationDirect, name = "showPolymerInformation"),
    path('showStrainsPerProteinGI/<str:proteinGI>', views.showStrainsPerProteinGIDirect, name = "showStrainsPerProteinGI"),
    path('showProteinGIsPerStrainIDAndProteinType/<int:strain_id>/<str:proteinType>', views.showProteinGIsPerStrainIDAndProteinTypeDirect, name = "showProteinGIsPerStrainIDAndProteinTypeDirect"),
    path('showAlignment/<str:protein_type>/<str:aln_name>/<str:tax_group>', views.showAlignmentDirect, name = 'showAlignment'),
    path('getProteinGIsFilterByStrainIDAndProteinType/<int:strain_id>/<str:proteinType>', views.getProteinGIsFilterByStrainIDAndProteinTypeDirect, name = "getProteinGIsFilterByStrainIDAndProteinType"),
    path('getProteinGIsFilterByProteinType/<str:proteinType>', views.getProteinGIsFilterByProteinTypeDirect, name = "getProteinGIsFilterByProteinType"),
    path('getStrainIdsFilterByProteinGI/<str:proteinGI>', views.getStrainIdsFilterByProteinGIDirect, name = 'getStrainIdsFilterByProteinGI'),
]