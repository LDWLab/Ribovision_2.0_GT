...
for entry in csv_list[1:]:
    ...
    if secondary_structure_id != 0:
        query = "INSERT INTO `SEREB`.`LineLabels`(`LineLabel_id`,`X1`,`Y1`,`X2`,`Y2`,`Fill`,`Stroke`,`StrokeWidth`,`StrokeLineJoin`,`StrokeMiterLimit`,`secondary_structure_id`) VALUES('"+entry[0]+"','"+entry[1]+"','"+entry[2]+"','"+entry[3]+"','"+entry[4]+"','"+entry[5]+"','"+entry[6]+"','"+entry[7]+"','"+entry[8]+"','"+entry[9]+"','"+str(secondary_structure_id)+"')"
