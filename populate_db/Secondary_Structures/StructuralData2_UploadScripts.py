...
for entry in csv_list[1:]:
    ...
    if secondary_structure_id != 0:
        query = "INSERT INTO `SEREB`.`StructuralData2`(`map_index`,`Domain_RN`,`Domain_AN`,`Domains_Color`,`Helix_Num`,`Helix_Color`,`secondary_structure_id`) VALUES('"+entry[0]+"','"+entry[1]+"','"+entry[2]+"','"+entry[3]+"','"+entry[4]+"','"+entry[5]+"','"+str(secondary_structure_id)+"')"
        print(query)
