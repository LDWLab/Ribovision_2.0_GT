        ...
        <div class="left-sidebar">
            ...
            <p>
                ...
                <div v-if="alnobj&&alnobj=='custom'&&file&&type_tree=='upload'">
                    ...
                    <input id="uploadCustomFullSequence" class="btn btn-outline-dark" type="file" accept=".txt" ref="customFullSequence" v-on:change="uploadCustomFullSequence()"></input>
...
<script>
  ...
  //import {parseRNAchains} from './handleRNAchains.js'
  //const hardcoded_structure = "";
  export default {
      ...
      watch: {
        ...
        postStructureData(pdbid, chainid) {
            ...
            uploadCustomPDB(vm.customFullSequence ?? "");
