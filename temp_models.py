...
class Interactions(models.Model):
    ...
    residue_i = models.ForeignKey('Residues', models.DO_NOTHING, db_column='residue_i', blank=True, null=True)
    residue_j = models.ForeignKey('Residues', models.DO_NOTHING, db_column='residue_j', blank=True, null=True)
...
class OldName(models.Model):
    ...
    nn_fk = models.ForeignKey(Nomenclature, models.DO_NOTHING)
...
class PolymerMetadata(models.Model):
    ...
    accession_range = models.CharField(max_length=60, blank=True, null=True)
